...
One thing to note about local front-end dev: if you add, remote, or modify any of the assets in the `images` folder, you will need to restart the dev server for those changes to be picked up (or manually run `npm run build:images`).
