...
export default {
  ...
  FIREBASE_STORAGE_BUCKET: 'INSERT FROM FIREBASE CONSOLE',
  FIREBASE_MESSAGING_SENDER_ID: 'INSERT FROM FIREBASE CONSOLE',
  FIREBASE_APP_ID: 'INSERT FROM FIREBASE CONSOLE'
}
