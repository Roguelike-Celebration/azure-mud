...
interface BlockToggleAction {
  type: ActionType.BlockToggle;
  value: string;
}

export const BlockToggleAction = (userId: string): BlockToggleAction => {
  return { type: ActionType.BlockToggle, value: userId }
}
