...
import unconfRooms from './unconfRooms'
...
export const roomData: { [name: string]: Room } = {
  ...
  southShowcaseHall,
  westShowcaseHall,
  unconfRooms, // I understand all the rooms in unconfRooms need to be added to roomData. Not sure if this is how to do it. -kawa
  kitchen: {
    id: 'kitchen',
    displayName: 'Kitchen',
