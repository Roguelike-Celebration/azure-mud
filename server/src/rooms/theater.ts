export default {
  ...
  description: `
        ...
        <br/><br/>
        <center id="iframes"><iframe width="560" height="315" src="https://www.youtube.com/embed/live_stream?channel=UCKv_QzXft4mD6TXmQBZtzIA" frameborder="0" allowfullscreen></iframe>
