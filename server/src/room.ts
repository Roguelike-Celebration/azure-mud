...
export interface Room {
  ...
  // Flavor text describing the room
  description: string

  // Flavor text describing the room's exits. These will be hyperlinked on the client.
...
export const roomData: { [name: string]: Room } = {
  kitchen: {
    ...
    exitDescription: 'From here, you can walk over to the [[bar]] or grab a seat in the [[main theatre area->theatre]].',
    allowsMedia: true,
    hasNoteWall: true
  },
  theatre: {
  ...
  bar: {
    ...
    displayName: 'Bar',
    shortName: 'the bar',
    description: 'A beautiful long bar with hundreds of bottles spanning up to the ceiling. A friendly bartender will happily make you whatever you want. A laminated sign on the bartop advertises tonight\'s specials: the Tourist (a non-alcoholic drink with lots of fruit and a fun umbrella), the Berlin Interpretation (a mojito made with some sort of hyper-caffeinated soda), and the Walls Are Shifting (a Long Island Iced Tea).',
    exitDescription: 'You\'re a stone\'s throw away from the [[kitchen]], the [[theatre]], the [[dance floor]], and the [[lounge]]. You can also crawl into the [[shipping container->shippingContainer]].',
    allowsMedia: true
  },
  lounge: {
    id: 'lounge',
    ...
    description: 'A chill space to hang away from the hustle and bustle of the main space. Comfy chairs, TVs showing video footage of roguelikes, and a fridge full of La Croix.',
    exitDescription: 'From here, you can get to the [[bar]] or the [[theatre]].',
    allowsMedia: true
  },
  statue: {
    id: 'statue',
  ...
  danceFloor: {
    ...
    description: 'The ping-pong table has been pushed to the side for a makeshift dance floor. A DJ booth is set up where chiptunes are playing.',
    exitDescription: 'From here, you can reach [[the kitchen]] or [[the bar]].'
  },
  shippingContainer: {
    ...
    description: `
      It's not quite clear why there's a shipping container in the middle of the space. Seems pretty chill, though? Somebody's set up a makeshift bench.`,
    exitDescription: 'After you climb out, you can get back to the [[bar]], the [[theatre]], the [[kitchen]], or the [[lounge]].',
    allowsMedia: true
  },
  entryway: {
    id: 'entryway',
    ...
    description: 'A big banner reads \'Welcome to Roguelike Celebration!\'',
    exitDescription: 'Once you\'ve got your bearings about you, you can move to the [[lounge]].',
    hidden: true
  },
  northShowcaseHall: {
    ...
    exitDescription: 'You can exit to the [[west hall->westShowcaseHall]] or [[east hall->eastShowcaseHall]]',
    allowsMedia: true
  },
  eastShowcaseHall: {
    id: 'eastShowcaseHall',
    ...
    exitDescription: 'You can exit to the [[north hall->northShowcaseHall]] or [[south hall->southShowcaseHall]]',
    allowsMedia: true
  },
  southShowcaseHall: {
