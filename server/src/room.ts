...
export const roomData: { [name: string]: Room } = {
  ...
  lounge: {
    ...
    description: 'A chill space to hang away from the hustle and bustle of the main space. Comfy chairs, TVs showing video footage of roguelikes, and a fridge full of La Croix. <br/><br/>From here, you can get to the [[bar]], the [[theatre]], or the entrance to the [[unconference]] rooms.',
    allowsMedia: true
  },
  statue: {
    id: 'statue',
  ...
  minetown: {
    ...
    shortName: 'minetown',
    description: 'The clink of picks and sound of distant crashing rock forms a percussive backbeat to this underground town square. Dozens of candles are set into the walls, casting the space in a warm glow. A fountain stands in the center of the square, along with a large sign reading "NO SPLASHING"<br/><br/>This is a room for unconferencing! The other unconferencing rooms are [[Oracle]], [[Castle]], [[Vlad\'s Tower]], [[Sokoban]], and [[Astral Plane]]. Or you can climb the stairs back up to the [[kitchen]] in the main space.',
    hasNoteWall: true
  },
  oracle: {
    id: 'oracle',
  ...
  tower: {
    ...
    description: 'Squeaking bats and howling wolves give a festive October ambiance to this gothic tower, as you stand in the center courtyard. Small niches holding antique weaponry or suits of armour surround the yard, which can function as uncomfortably crowded break out rooms in a pinch. From far above you can hear two voices laughing, one feminine and one Transylvanian - but the reclining dragon by the stairs opens a warning eye if you venture too close.<br/><br/>This is a room for unconferencing! The other unconferencing rooms are [[Minetown]], [[Oracle]], [[Castle]], [[Sokoban]], and [[Astral Plane]]. Or you can go back down to the [[kitchen]] in the main space.',
    hasNoteWall: true
  },
  castle: {
    id: 'castle',
