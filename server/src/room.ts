...
export const roomData: { [name: string]: Room } = {
  ...
  lounge: {
    ...
    description: 'A chill space to hang away from the hustle and bustle of the main space. Comfy chairs, TVs showing video footage of roguelikes, and a fridge full of La Croix. <br/><br/>From here, you can get to the [[bar]], the [[theatre]], or the entrance to the [[unconferencing rooms->unconference]].',
    allowsMedia: true
  },
  unconference: {
    id: 'unconference',
