...
export const generate = () => {
  const grammar = tracery.createGrammar({
    origin: [
      'A young goblin stares at you, wearing a floppy, multicolored hat, his eyes pleading for your mercy.',
      'He glances at you as he dips a battered hot dog into hot oil.',
