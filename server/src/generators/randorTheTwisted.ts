...
export const generate = () => {
  var grammar = tracery.createGrammar({
    origin: [
	  ...
	  'He sits pondering an orb filled with a blood red mist and emitting a quiet sound of birdsong.',
	  'In his hands is a notebook crafted of rotten flesh and inked with blood. He quietly sighs, unable to focus on its content.',
