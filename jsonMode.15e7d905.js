...
})({"4HfYL":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "54a964cfc6aab16a9793aa9b15e7d905"; // @flow
...
var JSONState = class {
    ...
    lastWasColon;
    parents;
    constructor(state1, scanError, lastWasColon, parents){
        this._state = state1;
...
function tokenize(comments, line, state2, offsetDelta = 0) {
    let numberOfInsertedCharacters = 0;
    let adjustOffset = false;
    switch(state2.scanError){
        case 2:
            line = '"' + line;
    ...
    let lastWasColon1 = state2.lastWasColon;
    let parents1 = state2.parents;
    const ret = {
        tokens: [],
        endState: state2.clone()
    };
    while(true){
        ...
        switch(kind){
            case 1:
                parents1 = ParentsStack.push(parents1, 0/* Object */ );
                type2 = TOKEN_DELIM_OBJECT;
                lastWasColon1 = false;
                break;
            case 2:
                parents1 = ParentsStack.pop(parents1);
                type2 = TOKEN_DELIM_OBJECT;
                lastWasColon1 = false;
                break;
            case 3:
                parents1 = ParentsStack.push(parents1, 1/* Array */ );
                type2 = TOKEN_DELIM_ARRAY;
                lastWasColon1 = false;
                break;
            case 4:
                parents1 = ParentsStack.pop(parents1);
                ...
                break;
            case 6:
                type2 = TOKEN_DELIM_COLON;
                lastWasColon1 = true;
                break;
            case 5:
                type2 = TOKEN_DELIM_COMMA;
                lastWasColon1 = false;
                break;
            case 8:
            case 9:
                type2 = TOKEN_VALUE_BOOLEAN;
                lastWasColon1 = false;
                break;
            case 7:
                type2 = TOKEN_VALUE_NULL;
                lastWasColon1 = false;
                break;
            case 10:
                const currentParent = parents1 ? parents1.type : 0/* Object */ ;
                const inArray = currentParent === 1/* Array */ ;
                type2 = lastWasColon1 || inArray ? TOKEN_VALUE_STRING : TOKEN_PROPERTY_NAME;
                lastWasColon1 = false;
                break;
            case 11:
                type2 = TOKEN_VALUE_NUMBER;
                lastWasColon1 = false;
                break;
        }
        if (comments) switch(kind){
            case 12:
                type2 = TOKEN_COMMENT_LINE;
                break;
            case 13:
                type2 = TOKEN_COMMENT_BLOCK;
                break;
        }
        ret.endState = new JSONState(state2.getStateData(), scanner.getTokenError(), lastWasColon1, parents1);
        ret.tokens.push({
            startIndex: offset,
            scopes: type2
        });
...
var JSONDiagnosticsAdapter = class extends DiagnosticsAdapter {
    constructor(languageId, worker, defaults1){
        super(languageId, worker, defaults1.onDidChange);
    ...
    _resetSchema(resource) {
        this._worker().then((worker1)=>{
            worker1.resetSchema(resource.toString());
        });
    }
};
function setupMode(defaults2) {
    const disposables = [];
    const providers = [];
    const client = new WorkerManager(defaults2);
    disposables.push(client);
    const worker1 = (...uris)=>{
        return client.getLanguageServiceWorker(...uris);
    };
    function registerProviders() {
        const { languageId: languageId1 , modeConfiguration: modeConfiguration2  } = defaults2;
        disposeAll(providers);
        if (modeConfiguration2.documentFormattingEdits) providers.push(monaco_editor_core_exports.languages.registerDocumentFormattingEditProvider(languageId1, new DocumentFormattingEditProvider(worker1)));
        if (modeConfiguration2.documentRangeFormattingEdits) providers.push(monaco_editor_core_exports.languages.registerDocumentRangeFormattingEditProvider(languageId1, new DocumentRangeFormattingEditProvider(worker1)));
        if (modeConfiguration2.completionItems) providers.push(monaco_editor_core_exports.languages.registerCompletionItemProvider(languageId1, new CompletionAdapter(worker1, [
            " ",
            ":",
            '"'
        ])));
        if (modeConfiguration2.hovers) providers.push(monaco_editor_core_exports.languages.registerHoverProvider(languageId1, new HoverAdapter(worker1)));
        if (modeConfiguration2.documentSymbols) providers.push(monaco_editor_core_exports.languages.registerDocumentSymbolProvider(languageId1, new DocumentSymbolAdapter(worker1)));
        if (modeConfiguration2.tokens) providers.push(monaco_editor_core_exports.languages.setTokensProvider(languageId1, createTokenizationSupport(true)));
        if (modeConfiguration2.colors) providers.push(monaco_editor_core_exports.languages.registerColorProvider(languageId1, new DocumentColorAdapter(worker1)));
        if (modeConfiguration2.foldingRanges) providers.push(monaco_editor_core_exports.languages.registerFoldingRangeProvider(languageId1, new FoldingRangeAdapter(worker1)));
        if (modeConfiguration2.diagnostics) providers.push(new JSONDiagnosticsAdapter(languageId1, worker1, defaults2));
        if (modeConfiguration2.selectionRanges) providers.push(monaco_editor_core_exports.languages.registerSelectionRangeProvider(languageId1, new SelectionRangeAdapter(worker1)));
    }
    registerProviders();
    disposables.push(monaco_editor_core_exports.languages.setLanguageConfiguration(defaults2.languageId, richEditConfiguration));
    let modeConfiguration = defaults2.modeConfiguration;
    defaults2.onDidChange((newDefaults)=>{
...
},{"../../editor/editor.api.js":"4ekrL","@parcel/transformer-js/src/esmodule-helpers.js":"367CR"}]},["4HfYL"], null, "parcelRequire4f3a")

//# sourceMappingURL=jsonMode.15e7d905.js.map
